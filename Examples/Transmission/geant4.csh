...
#-----------------------------------------------------------------------
# C shell environment setup script for Geant4 10.2.3
#
...
if ( ! ${?LD_LIBRARY_PATH} ) then
  setenv LD_LIBRARY_PATH C:/Users/chris/Geant4/xerces-c-3.2.2/install/lib
else
  setenv LD_LIBRARY_PATH ${LD_LIBRARY_PATH}:C:/Users/chris/Geant4/xerces-c-3.2.2/install/lib
endif
...
# Resource file paths
# - Datasets
setenv G4NEUTRONHPDATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/G4NDL4.5 > /dev/null ; pwd`"
setenv G4LEDATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/G4EMLOW6.48 > /dev/null ; pwd`"
setenv G4LEVELGAMMADATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/PhotonEvaporation3.2 > /dev/null ; pwd`"
setenv G4RADIOACTIVEDATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/RadioactiveDecay4.3.2 > /dev/null ; pwd`"
setenv G4NEUTRONXSDATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/G4NEUTRONXS1.4 > /dev/null ; pwd`"
setenv G4PIIDATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/G4PII1.3 > /dev/null ; pwd`"
setenv G4REALSURFACEDATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/RealSurface1.0 > /dev/null ; pwd`"
setenv G4SAIDXSDATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/G4SAIDDATA1.1 > /dev/null ; pwd`"
setenv G4ABLADATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/G4ABLA3.0 > /dev/null ; pwd`"
setenv G4ENSDFSTATEDATA "`cd $geant4_envbindir/../share/Geant4-10.2.3/data/G4ENSDFSTATE1.2.3 > /dev/null ; pwd`"
